...
require_once OEMM_PLUGIN_DIR . 'api/class-oemm-exports.php';
...
function oemm_init() {
    if ( ! class_exists( 'WooCommerce' ) ) {
        add_action( 'admin_notices', function() {
            echo '<div class="error"><p><strong>ÖMM Startliste:</strong> WooCommerce muss aktiv sein.</p></div>';
        });
        return;
    }
